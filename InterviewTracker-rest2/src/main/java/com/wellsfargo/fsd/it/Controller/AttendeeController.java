...
//	@GetMapping("/{id}")
//	public ResponseEntity<List<AttendeeEntity>> getAllAttendees(@PathVariable("id") int interview)
//	{
//		return new ResponseEntity<List<AttendeeEntity>>(attendeeService.getAllAttendees(interview),HttpStatus.OK);
//		
//	}
	@PostMapping
